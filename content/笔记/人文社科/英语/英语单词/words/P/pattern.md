...
##### 词义
- 英：/ˈpætn/； 美：/ˈpætərn/
- #词性/n  模式；图案；方式；模型；式样；花样；样品；样板；范例；榜样；典范
- #词性/vt  构成图案(或花样)；使形成，促成(某行为模式)
##### 例句
...
- This system sets the pattern for others to follow .
	- 这个系统堪为他人仿效的典范。
##### 形态
- #形态/word_third patterns
- #形态/word_ing patterning
- #形态/word_done patterned
- #形态/word_pl patterns
- #形态/word_past patterned
