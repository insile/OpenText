...
- #词性/v  转换；转化；(使)转变；(使)改变(宗教或信仰)；（使）改变（观点、习惯等）；(使)皈依；可转变为；可变换成；归附；获得附加分
- #词性/n  改变宗教(或信仰、观点)的人；皈依者
# 例句
...
- We 've converted from oil to gas central heating .
	- 我们已经把中央供热系统由燃油改成了燃气。
# 形态
- #形态/word_third converts
- #形态/word_ing converting
- #形态/word_done converted
- #形态/word_pl converts
- #形态/word_past converted
