...
- #词性/vt  （使）复杂化，变复杂；并发(病)，使恶化；使卷入，使陷入；牵连
- #词性/adj  <植>褶叠的；<昆>(翅膀)纵折的；由密切相关的部件组成的
# 例句
...
- The situation was more complicated than they had at first realized .
	- 形势比他们最初意识到的更为复杂。
# 形态
- #形态/word_third complicates
- #形态/word_ing complicating
- #形态/word_done complicated
- #形态/word_past complicated
