...
- #词性/adj  相应的；重要的；随之而来的；作为结果的；相应发生的；将产生重大结果的
# 例句
...
- At the same time , based on the combination of the simulation results , the model has made consequential amendments .
	- 同时在此基础上结合仿真分析，对该模型作出了相应的修正。
