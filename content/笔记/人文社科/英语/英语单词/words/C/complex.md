...
- #词性/adj  复杂的；复合的(指词根加有词缀或主句含有从句)；难懂的；费解的
- #词性/n  情结；(类型相似的)建筑群；相关联的一组事物；不正常的精神状态；（对某事）不正常的忧虑
# 例句
...
- This is just one of a whole complex of issues .
	- 这仅仅是所有相关的问题之一。
# 形态
- #形态/word_pl complexes
- #形态/word_est most complex
- #形态/word_er more complex
