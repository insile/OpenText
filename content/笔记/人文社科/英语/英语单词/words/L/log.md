...
# 词义
- 英：/lɒɡ/； 美：/lɔːɡ/
- #词性/n  日志；对数；原木，圆材，干材；(尤指)航海日志，飞行日志；<海>计程仪, 测程仪；(某时期事件的)正式记录；<机>运转记录；<英口>机动车车主登记册(用以颁发执照)
- #词性/vt  记录，把…载入正式记录；<计>登录；行驶，行进(若干距离或时间)；采伐(森林的)树木；把(树木)锯成段木；把…载入航海(或飞行)日志；以…速度航行(或飞行)
# 例句
