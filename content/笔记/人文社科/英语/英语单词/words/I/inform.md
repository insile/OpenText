...
- #词性/v  知会，通知，告知；报告；（使）了解，（使）熟悉；影响（意见、态度或风格等）；训练，教育；形成；提供资料（或消息、情报等）；带领，引导；通告；宣布；使充满；告发，检举；渗透入；赋特征于
- #词性/adj  不成形的，无形的
# 例句
...
- We need time to inform ourselves thoroughly of the problem .
	- 我们需要时间对这个问题有个透彻的了解。
# 形态
- #形态/word_third informs
- #形态/word_ing informing
- #形态/word_done informed
- #形态/word_past informed
