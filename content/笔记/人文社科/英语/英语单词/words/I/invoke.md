...
# 词义
- 英：/ɪnˈvəʊk/； 美：/ɪnˈvoʊk/
- #词性/vt  调用；援引；使产生，唤起，引起（感情或想象）；援用(法律、规则等作为行动理由)；提及(某人、某理论、实例等作为支持)；向（某人）请求帮助；用法术召唤（魔鬼）；提出(某人的名字，以激发某种感觉或行动)
# 例句
...
- This command will invoke the HELP system .
	- 这条指令将启用“帮助”系统。
# 形态
- #形态/word_third invokes
- #形态/word_ing invoking
- #形态/word_done invoked
- #形态/word_past invoked
