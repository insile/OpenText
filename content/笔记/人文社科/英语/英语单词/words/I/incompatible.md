...
- #词性/adj  不相容的，不兼容的，互斥的；（与某事物）不一致，不相配；不协调的；（与某物）不匹配；（药物）配伍禁忌的；（与某人）合不来的，不能和睦相处；（血型、机体组织）不能配合的；（植物）不可嫁接的，不能自花受精的；（职位、封地等）不能同时享有的
- #词性/n  互不相容的人（或事物）；配伍禁忌的药物；不能配合的血型（或机体组织）
# 例句
