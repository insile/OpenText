...
# 词义
- 英：/ˈɪndeks/； 美：/ˈɪndeks/
- #词性/n  (物价和工资等的)指数；索引；指标；标志；表征；量度
- #词性/vt  使指数化；将…编入索引；为…编索引；将(工资等)与(物价水平等)挂钩
# 例句
...
# 形态
- #形态/word_third indexes
- #形态/word_ing indexing
- #形态/word_done indexed
- #形态/word_pl indices
- #形态/word_past indexed
