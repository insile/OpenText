...
- #词性/n  接口；(人机)界面(尤指屏幕布局和菜单)；接口程序；连接电路；(两学科、体系等的)接合点，边缘区域
- #词性/v  (使通过界面或接口)接合，连接
# 例句
...
- The new system interfaces with existing telephone equipment .
	- 新系统与现有的电话设备相连接。
# 形态
- #形态/word_third interfaces
- #形态/word_ing interfacing
- #形态/word_done interfaced
- #形态/word_pl interfaces
- #形态/word_past interfaced
