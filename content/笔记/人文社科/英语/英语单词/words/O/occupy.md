...
- #词性/v  （用武力）占领，侵占；使用，占用（空间、面积、时间等）；占据；使用（房屋、建筑），居住；承担，（尤指）担任（要职）；使从事，使关注，使花费时间；<废>用…做交易，投资 (若干数目)；使忙于（做某事），忙着（做某事）；使 (头脑等) 全神贯注
# 例句
...
# 形态
- #形态/word_third occupies
- #形态/word_ing occupying
- #形态/word_done occupied
- #形态/word_past occupied
