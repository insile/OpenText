...
- #词性/v  排出；释放；流出；放出；尽（职）；解雇；发（力）；射出；准许(某人)离开
- #词性/n  排出(物)；(任务或职责的)履行，执行；出院；流出(物)；放出(物)；(债务的)清偿；退伍；免职；获准离开
# 例句
...
- Patients were being discharged from the hospital too early .
	- 病人都过早获准出院。
# 形态
- #形态/word_third discharges
- #形态/word_ing discharging
- #形态/word_done discharged
- #形态/word_past discharged
