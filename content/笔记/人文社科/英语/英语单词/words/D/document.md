...
- #词性/n  文件；(计算机)文档；文献；证件；公文
- #词性/vt  记录，记载(详情)；用文件证明(或证实)
# 例句
...
- She worked her way through the pile of documents .
	- 她从头至尾处理了那一堆文件。
# 形态
- #形态/word_third documents
- #形态/word_ing documenting
- #形态/word_done documented
- #形态/word_pl documents
- #形态/word_past documented
