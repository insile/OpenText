...
- #词性/v  分离；(使)分开；隔开；分割；区分；分居；划分；(使)分散；阻隔
- #词性/adj  单独的；分开的；独立的；不同的；不相关的
- #词性/n  单行本；可以不配套单独穿的妇女服装；(杂志论文的)抽印本
# 例句
...
- It is essential to keep the two groups separate .
	- 将这两组隔开是完全必要的。
# 形态
- #形态/word_third separates
- #形态/word_ing separating
- #形态/word_done separated
- #形态/word_past separated
