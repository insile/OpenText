...
- #词性/v  <化>（使）取代；接替，替代；(以…)代替，代用；派……接替，由……替代
- #词性/n  <语>替代（形式），代用词，代用语；代用品，代替者；替补队员；代替者，替换者；<海>(用于重复桅杆信号旗信号的)代用小信号旗, 代用旗；应征入伍者；<矿>转接器；<苏格兰><律>副职
- #词性/adj  代替的，代用的；替补的；由代用品构成的，用代用品的
# 例句
...
- Nothing can substitute for the advice your doctor is able to give you .
	- 大夫所能给你的忠告是无可替代的。
# 形态
- #形态/word_third substitutes
- #形态/word_ing substituting
- #形态/word_done substituted
- #形态/word_pl substitutes
- #形态/word_past substituted
