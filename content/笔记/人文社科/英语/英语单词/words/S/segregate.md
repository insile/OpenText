...
- #词性/v  (使)分开，分离，隔离；〈遗〉（基因）分离；〈冶〉偏析, 熔析；〈化〉分凝；（使）隔食；隔离并区别对待(不同种族、宗教或性别的人)
- #词性/adj  隔离的，分开的，分离的
- #词性/n  〈遗〉分离子；被隔离的人（或物、群体等）
# 例句
...
# 形态
- #形态/word_third segregates
- #形态/word_ing segregating
- #形态/word_done segregated
- #形态/word_past segregated
