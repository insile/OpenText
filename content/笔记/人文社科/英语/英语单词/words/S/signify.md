...
- #词性/v  代表，表示，象征；（通过某种行为）表示，表明；表达，显示（感情、意愿等）；说明，意思是；预示；具有重要性，要紧；.<美口>（黑人用语）吹牛，吹捧，辱骂；<美俚>冒充内行，装蒜
# 例句
...
# 形态
- #形态/word_third signifies
- #形态/word_ing signifying
- #形态/word_done signified
- #形态/word_past signified
