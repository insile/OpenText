...
- #词性/n  (价格、收费或条款等的)一览表，明细表，清单；日程安排；工作计划；(电视或广播)节目表
- #词性/vt  安排；预定；列入，收进(正式目录、清单等中)；为…安排时间
# 例句
...
- Chinese will be on the school schedule from next year .
	- 从明年开始中文将排进学校的课程表。
# 形态
- #形态/word_third schedules
- #形态/word_ing scheduling
- #形态/word_done scheduled
- #形态/word_pl schedules
- #形态/word_past scheduled
