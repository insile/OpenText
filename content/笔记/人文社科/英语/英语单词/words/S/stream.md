...
# 词义
- 英：/striːm/； 美：/striːm/
- #词性/v  流；流动；流出；用流式传输，流播；飘动；飘扬；按能力分班（或分组）；一个接一个地移动；鱼贯而行
- #词性/n  (液)流；班，组；溪；小河；一连串，接二连三，源源不断（的事情）
# 例句
...
- The new computer system comes on stream next month .
	- 新的计算机系统下月投入使用。
# 形态
- #形态/word_third streams
- #形态/word_ing streaming
- #形态/word_done streamed
- #形态/word_pl streams
- #形态/word_past streamed
