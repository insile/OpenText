...
- #词性/n  调查；测量；勘测；测绘；民意调查；民意测验；总体研究；(尤指为欲购房者所做的)房屋鉴定
- #词性/vt  测量；勘测；测绘；（对建筑物的）鉴定，检查；概述；审视；查看；总体研究；（对…）做民意调查，进行民意测验；审察；全面评述
# 例句
...
- This chapter briefly surveys the current state of European politics .
	- 本章对欧洲政治的现状作了简略概述。
# 形态
- #形态/word_third surveys
- #形态/word_ing surveying
- #形态/word_done surveyed
- #形态/word_pl surveys
- #形态/word_past surveyed
