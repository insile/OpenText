...
- #词性/v  （使）缩回，（使）缩进（爪、触角、舌头等）；撤回，收回（声明、诺言、意见等）；（使）收起（飞机起落架等）；变卦，食言；〈棋〉悔（着）；〈语〉收舌发（音）
# 例句
...
- He made a false confession which he later retracted .
	- 他作了假供词，后来又翻供。
# 形态
- #形态/word_third retracts
- #形态/word_ing retracting
- #形态/word_done retracted
- #形态/word_past retracted
