...
- #词性/v  使反转；颠倒；撤销，废除(决定、法律等)；交换（位置或功能）；使完全相反；（使）倒退行驶；使次序颠倒；彻底转变；承认错误；打对方付费的电话
- #词性/n  背面；反面；损失；倒挡；后面；相反的情况(或事物)
- #词性/adj  反向的；相反的；背面的；反面的；后面的
# 例句
...
- This problem is the reverse of the previous one .
	- 这个问题和上一个问题相反。
# 形态
- #形态/word_third reverses
- #形态/word_ing reversing
- #形态/word_done reversed
- #形态/word_pl reverses
- #形态/word_past reversed
