...
- #词性/vt  提供；使成为；使变得；提交；给予；递交；回报；呈献；使处于某状态
- #词性/v  提供；提交；给予；翻译；表达；（用不同的语言）表达；粉刷；将（脂肪）熬成油
- #词性/n  抹灰；粉刷；(墙壁的)初涂；精制油
# 例句
...
- Hundreds of people were rendered homeless by the earthquake .
	- 成百上千的人因为地震而无家可归。
# 形态
- #形态/word_third renders
- #形态/word_ing rendering
- #形态/word_done rendered
- #形态/word_past rendered
