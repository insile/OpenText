...
- #词性/v  转移(感情)；转让(权力等)；改变(环境)；转会，使转会；(使)调动；（使在旅途中）转乘，换乘，倒车；转学；(使)搬迁；转职；转存，转录（资料、音乐等）；传染(疾病)；让与
- #词性/n  转移；迁移；(运动员)转会；调动；变换；(旅途中的)中转；搬迁；转印图画，转印图案；转车票；改变路线
# 例句
...
- They could not ensure a smooth transfer of political power .
	- 他们无法保证政权的顺利交接。
# 形态
- #形态/word_third transfers
- #形态/word_ing transferring
- #形态/word_done transferred
- #形态/word_past transferred
