...
# 词义
- 英：/ˈvaɪtl/； 美：/ˈvaɪtl/
- #词性/adj  至关重要的，必不可少的；生命的；生命统计的，生死统计的；生气勃勃的，充满生机的；致命的，生死攸关的；对…极重要的；维持生命所必需的；热情洋溢的
- #词性/n  （常用复数）（心、脑、肝、肺、肾等）维持生命的重要器官；重要部分，要害
# 例句
...
# 形态
- #形态/word_est most vital
- #形态/word_er more vital
