...
- The apparatus can simulate the stable and dynamic property of marine propeller that works under different conditions , and provide verisimilar shaft load for propulsive motor .
	- 该装置能仿真螺旋桨在各种工况下的静、动态特性，为推进电机提供逼真的轴负载。
- In this thesis , in order to find out new ways to provide more convenient interaction and more verisimilar scenes in training emulator , the technologies of augmented reality and hand interaction are explored .
	- 论文针对在维修训练模拟系统中如何提高模拟场景的真实感，如何应用新颖方便的交互手段，研究了增强现实技术和手势交互技术。
