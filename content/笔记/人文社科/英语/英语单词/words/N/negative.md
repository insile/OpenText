...
- #词性/adj  负面的；消极的；负极的；否定的；有害的；坏的；结果为阴性的（或否定的）；缺乏热情的；含有否定词的
- #词性/n  否定；底片；负片；拒绝；否定词；属阴性(或否定)的结果
- #词性/vt  否定；拒绝；证伪；否定…的真实性
# 例句
...
- The crisis had a negative effect on trade .
	- 这次危机对贸易产生了很坏的影响。
# 形态
- #形态/word_third negatives
- #形态/word_ing negativing
- #形态/word_done negatived
- #形态/word_pl negatives
- #形态/word_past negatived
