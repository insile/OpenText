...
- #词性/v  提名；挑选，指定(时间、日期、名称等)；指定，指派；任命；推荐；命名
- #词性/adj  被提名的；被指定的；有特定名字的
# 例句
...
- 1 December has been nominated as the day of the election .
	- 12月1日被指定为选举日。
# 形态
- #形态/word_third nominates
- #形态/word_ing nominating
- #形态/word_done nominated
- #形态/word_past nominated
