##### 重积分变量替换
- 二重积分的变量替换
	- [[实函数|多元向量函数]] $\left\{\begin{matrix} x=g(u,v) \\ y=h(u,v) \end{matrix}\right.$ 可以把 $xy$ 平面区域的积分变换成 $uv$ 平面区域的积分
...
- 三重积分的变量替换
	- [[实函数|多元向量函数]] $\left\{\begin{matrix} x=g(u,v,w) \\ y=h(u,v,w)\\ z=k(u,v,w) \end{matrix}\right.$ 可以把 $xyz$ 空间区域的积分变换成 $uvw$ 空间区域的积分
