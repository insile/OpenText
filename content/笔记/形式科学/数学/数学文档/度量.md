##### 度量
- 度量
	- **度量**是定义在[[集合]] $S$ 上的一个[[映射]], 定义了集合内每一对元素之间的距离. 带有度量的集合叫做[[度量空间]]
		- $f:S\times S\to \mathbb{R}$, $x_1,x_2,x_3\in S$
			- 非负性, $f(x_1,x_2)=0\leftrightarrow x_1=x_2$
			- 对称性, $f(x_1,x_2)=f(x_2,x_1)$
			- 三角不等式, $f(x_1,x_3)\leq f(x_1,x_2)+f(x_2+x_3)$
	- [[范数|范数度量]]
