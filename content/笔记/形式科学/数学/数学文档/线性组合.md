##### 线性组合
- 线性组合
	- **线性组合**是指对给定的一[[向量组]]进行向量加法和标量乘法运算得到的新向量 $\mathbf{b}$, 即向量 $\mathbf{b}$ 可由向量组线性表示, 它们 $(\mathbf{a}_1,\mathbf{a}_2,...,\mathbf{a}_n,\mathbf{b})$ 是[[线性相关]]的, 可作为[[线性方程组等价形式]], 本质就是[[线性变换]]. 零向量 $\mathbf{0}$ 是任意向量组的线性组合. 线性变换 $T$ 保持线性组合. 线性组合可推广为[[仿射组合]], [[凸组合]], [[锥组合]]
