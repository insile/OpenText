##### 线性方程组
- 线性方程组
	- **线性方程组**是由 $n$ 个变量 $x_1,x_2,..,x_n$ 的[[线性方程]]组成的[[方程|方程组]], 常数项 $b$ 全为 $0$ 时称为齐次线性方程组, 否则为非齐次的, 线性方程组可用[[线性方程组矩阵记号|矩阵记号]]. 线性方程组的解是一组数, 所有可能的解的集合称为线性方程组的解集. 线性方程组存在不同[[线性方程组的形式|形式]], 是[[矩阵变换]]的一种实例
